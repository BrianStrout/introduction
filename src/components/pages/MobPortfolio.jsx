...
GoogleSheets API
    ...
    <p>This site is coded in HTML and Javascript utilizes an API that dynamically pulls and sorts categories and menu items from a google drive sheet allowing the restraurant to easily update a mobile version of their menu items and their details.
    </p>
    </div>
